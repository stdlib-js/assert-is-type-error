...
```bash
npm install @stdlib/assert-is-type-error
```
...
[test-image]: https://github.com/stdlib-js/assert-is-type-error/actions/workflows/test.yml/badge.svg
[test-url]: https://github.com/stdlib-js/assert-is-type-error/actions/workflows/test.yml
...
[dependencies-image]: https://img.shields.io/david/stdlib-js/assert-is-type-error
